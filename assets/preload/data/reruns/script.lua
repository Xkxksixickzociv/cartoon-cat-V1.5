...
function onCreate()
	makeLuaSprite('winningIcon', 'icons/win-bfr'..getProperty('boyfriend.healthicon'), getProperty('iconP1.x'), getProperty('iconP1.y'))
	...
	makeLuaSprite('winningIconDad', 'icons/win-cc'..getProperty('boyfriend.healthicon'), getProperty('iconP2.x'), getProperty('iconP2.y'))
...
function onUpdate(elapsed)
		...
		--then --uncomment if using WHITELIST or BLACKLIST
			makeLuaSprite('winningIconDad', 'icons/win-cc-angry'..getProperty('iconP2.animation.curAnim.name'), getProperty('iconP2.x'), getProperty('iconP2.y'))
			setObjectCamera('winningIconDad', 'hud')
			addLuaSprite('winningIconDad', true)
			setObjectOrder('winningIconDad', getObjectOrder('iconP2') + 1)
			setProperty('winningIconDad.flipX', false)
