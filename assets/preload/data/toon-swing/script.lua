...
function onCreate()
	makeLuaSprite('winningIcon', 'icons/win-bf-toon'..getProperty('boyfriend.healthicon'), getProperty('iconP1.x'), getProperty('iconP1.y'))
	...
	makeLuaSprite('winningIconDad', 'icons/win-cc-toon'..getProperty('boyfriend.healthicon'), getProperty('iconP2.x'), getProperty('iconP2.y'))
